...
function setGameOver() {
    ...
    //create un buton pentru resetare jocului
    resetButton = document.createElement("button");
    resetButton.textContent = "Reinitializeaza jocul";
    //colocamos el buton en el elemento parde body
    document.body.append(resetButton);
    //creamos el listener del buton
    resetButton.addEventListener("click", resetGame);
}

//creamos la function resetGame
